        ...
        <div className="lg:ml-auto xl:w-[38rem] mt-4">
          ...
          <div className="mt-4 relative left-1/2 flex w-[22rem] aspect-square border border-n-6 rounded-full -translate-x-1/2 scale-75 md:scale-100">
            <div className="flex m-auto border rounded-full w-60 aspect-square border-n-6">
              <div className="w-[6rem] aspect-square rounded-full m-auto bg-conic-gradient p-[0.2rem]">
                <div>
                  <img
                    src={brainwaveSymbol}
                    alt="brainwave"
                    className="flex items-center justify-center w-full h-full rounded-full bg-n-8"
                    width={48}
                    height={48}
                  />
                </div>
